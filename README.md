...
5. In the command prompt, type "cd C:\Users\Alice\Downloads" without the quotes and replace the file path with your path that you copied earlier ![command prompt](https://i.ibb.co/mGd81ps/cmd1.png)
6. ![command prompt2](https://i.ibb.co/R3QzJ7M/cmd2.png)
